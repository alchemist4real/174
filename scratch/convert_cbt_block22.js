...
.logo-wordmark span { color: #8A5C00; }
...
.meta-chip .dot { width: 6px; height: 6px; border-radius: 50%; background: #8A5C00; }
...
const cbtFiles22 = [
  { file: '2.2 CBT 1_22 FUFUFAFA.html', title: '22 FUFUFAFA', topic: 'Digestive System Essentials' },
  { file: '2.2 CBT 1_23 JOKROWI.html', title: '23 JOKROWI', topic: 'Digestive & Nephrourinary' },
  { file: '2.2 CBT 1_24 PRANOWO.html', title: '24 PRANOWO', topic: 'Blok 2.2 Digestif & Nefrourenal' },
  { file: '2.2 CBT 1_45 BAXLIL.html', title: '45 BAXLIL', topic: 'Soal Berulang Digestif' },
  { file: '2.2 CBT 2_22 ANTON AYAM.html', title: '22 ANTON AYAM', topic: 'Nephrourinary Essentials' },
  { file: '2.2 CBT 2_23 TONO GALON.html', title: '23 TONO GALON', topic: 'CBT 2 Nephrourinary' },
  { file: '2.2 CBT 2_24 AMBAR LAUNDRY.html', title: '24 AMBAR LAUNDRY', topic: 'Paket CBT 2.2 Komprehensif' },
  { file: '2.2 CBT 2_45 TAHUN COPY PASTE.html', title: '45 TAHUN COPY PASTE', topic: 'Paket Bank Soal CBT 2' },
  { file: '2.2 CBT 2_DEATHPAMIN 2.html', title: 'DEATHPAMIN II', topic: 'Cardiovictus 2.2 Lanjutan' },
  { file: '2.2 CBT 2_DEATHPAMIN.html', title: 'DEATHPAMIN I', topic: 'Cardiovictus 2.2 Dasar' },
  { file: '2.2 OTHER_25 PARNO SAPI.html', title: '25 PARNO SAPI', topic: 'Cardiovictus 2.2 Komprehensif' }
];

const basePath = path.join(process.cwd(), 'content', 'semester 2', '2.2');

cbtFiles22.forEach(item => {
  ...
  if (match) {
    ...
    const outputHtml = getCbtTemplate(item.title, '2.2', item.topic, JSON.stringify(normalized, null, 2));
    fs.writeFileSync(filePath, outputHtml, 'utf8');
    console.log('Successfully migrated ' + item.file + ' (' + normalized.length + ' questions)');
  } else {
    console.error('Could not extract questions from ' + item.file);
  }
});
